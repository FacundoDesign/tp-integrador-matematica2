...
# --- MENÚ INTERACTIVO ORIGINAL PARA OPERACIONES CON DNIs ---
print("\n" + "="*50)
print("MENÚ DE OPERACIONES CON CONJUNTOS DE DNIs")
print("="*50)
...
while operacion != "0":
    if operacion == "1":
        ...
        # Mostrar condiciones lógicas
        print(f"\nCondiciones lógicas:")
        print(f"- Grupo Z (todos > 2000): {'Sí' if all(ano > 2000 for ano in anos_nacimiento) else 'No'}")
        print(f"- Año especial (bisiesto): {'Sí' if anos_bisiestos else 'No'}")
        print(f"- Total pares en producto cartesiano: {len(anos_nacimiento) * len(edades_actuales)}")
        print()
